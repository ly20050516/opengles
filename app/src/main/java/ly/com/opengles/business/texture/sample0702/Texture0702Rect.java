...
public class Texture0702Rect {
    ...
    public Texture0702Rect(Texture0702SurfaceView mv, float sRange, float tRange) {
        //设置s纹理坐标范围
        this.sRange = sRange;
        //设置t纹理坐标范围
        this.tRange = tRange;
    ...
    //初始化shader
    public void initShader(Texture0702SurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("texture_sample_7_2/vertex.glsl", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("texture_sample_7_2/frag.glsl", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
