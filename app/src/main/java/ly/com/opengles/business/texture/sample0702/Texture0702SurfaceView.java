package ly.com.opengles.business.texture.sample0702;

/**
 * @author：ly on 2019-11-10 00:31
...
class Texture0702SurfaceView extends GLSurfaceView
{
    ...
    Texture0702Rect[] texRect=new Texture0702Rect[3];//纹理矩形数组
    int trIndex=2;//当前纹理矩形索引

    public Texture0702SurfaceView(Context context) {
        super(context);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                for(Texture0702Rect tr:texRect)
                {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三个纹理矩形对对象
            texRect[0]=new Texture0702Rect(Texture0702SurfaceView.this,1,1);
            texRect[1]=new Texture0702Rect(Texture0702SurfaceView.this,4,2);
            texRect[2]=new Texture0702Rect(Texture0702SurfaceView.this,4,4);
            //打开深度检测
    ...
    public int initTexture(boolean isRepeat)//textureId
    {
        ...
        try
        {
            bitmapTmp = BitmapFactory.decodeResource(getResources(), R.mipmap.robot);
        }
        finally
        {
