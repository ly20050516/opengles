 ...
 */
public class Fragment1402SurfaceView extends GLSurfaceView {
    ...
    public Fragment1402SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            //初始化光源位置
            MatrixState.setLightLocation(1f, 1f, 1f);
            //初始化变换矩阵
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball=new Ball(Fragment1402SurfaceView.this);
            //打开深度检测
