...
/**
 * @author：ly on 2019-11-11 22:13
 * @mail：liuyan@zhimei.ai
 */
public class Light0603SurfaceView extends GLSurfaceView {
    ...
    public Light0603SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new Ball(Light0603SurfaceView.this);
            //打开深度检测
