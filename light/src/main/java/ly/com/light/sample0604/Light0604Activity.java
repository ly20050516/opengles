...
public class Light0604Activity extends AppCompatActivity {

    private Light0604SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new Light0604SurfaceView(this);
        // 切换到主界面
        setContentView(R.layout.activity_light0604);
