...
public class Light0605Activity extends AppCompatActivity {

    private Light0605SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new Light0605SurfaceView(this);
        // 切换到主界面
        setContentView(R.layout.activity_light0605);
