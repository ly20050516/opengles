...
public class Light0606Activity extends AppCompatActivity {

    private Light0606SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new Light0606SurfaceView(this);
        // 切换到主界面
        setContentView(R.layout.activity_light0606);
