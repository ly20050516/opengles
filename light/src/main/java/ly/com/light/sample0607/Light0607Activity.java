...
public class Light0607Activity extends AppCompatActivity {

    private Light0607SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new Light0607SurfaceView(this);
        // 切换到主界面
        setContentView(R.layout.activity_light0607);
