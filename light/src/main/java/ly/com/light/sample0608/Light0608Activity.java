...
public class Light0608Activity extends AppCompatActivity {

    private Light0608SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new Light0608SurfaceView(this);
        // 切换到主界面
        setContentView(R.layout.activity_light0608);
