...
/**
 * @author：ly on 2019-11-23 15:58
 * @mail：liuyan@zhimei.ai
 */
public class Light0609SurfaceView extends GLSurfaceView {
    ...
    public Light0609SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            // 调用此方法产生摄像机9参数位置矩阵
            MatrixState.setCamera(0, 0f, 16f, 0f, 0f, 0f, 0f, 1.0f, 0.0f);
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball=new Ball(Light0609SurfaceView.this);
            //打开深度检测
