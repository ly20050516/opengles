 ...
 */
public class MixFog1001SurfaceView extends GLSurfaceView {
    ...
    public MixFog1001SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            keyThread = new KeyThread(MixFog1001SurfaceView.this);
            keyThread.start();
        }
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            ch = LoadUtil.loadFromFileVertexOnlyAverage("ch.obj", MixFog1001SurfaceView.this.getResources(), MixFog1001SurfaceView.this);
            pm = LoadUtil.loadFromFileVertexOnlyFace("pm.obj", MixFog1001SurfaceView.this.getResources(), MixFog1001SurfaceView.this);
            ;
            cft = LoadUtil.loadFromFileVertexOnlyFace("cft.obj", MixFog1001SurfaceView.this.getResources(), MixFog1001SurfaceView.this);
            ;
            qt = LoadUtil.loadFromFileVertexOnlyAverage("qt.obj", MixFog1001SurfaceView.this.getResources(), MixFog1001SurfaceView.this);
            ;
            yh = LoadUtil.loadFromFileVertexOnlyAverage("yh.obj", MixFog1001SurfaceView.this.getResources(), MixFog1001SurfaceView.this);
            ;
            rect = new TextureRect(MixFog1001SurfaceView.this, 10, 10);
        }
    }
