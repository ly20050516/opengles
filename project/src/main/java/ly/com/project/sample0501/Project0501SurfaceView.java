 ...
 */
public class Project0501SurfaceView extends GLSurfaceView {
    ...
    public Project0501SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            for (int i = 0; i < ha.length; i++) {
                ha[i] = new SixPointedStar(Project0501SurfaceView.this, 0.2f, 0.5f, -0.3f * i);
            }
            //打开深度检测
