package ly.com.project.sample0501;
...
public class SixPointedStar {
    ...
    public SixPointedStar(Project0501SurfaceView mv, float r, float R, float z) {
    ...
    public void initShader(Project0501SurfaceView mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("project_sample_5_1/vertex.glsl",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("project_sample_5_1/frag.glsl",
                mv.getResources());
        //基于顶点着色器与片元着色器创建程序
