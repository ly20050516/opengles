 ...
 */
public class Project0502SurfaceView extends GLSurfaceView {
    ...
    public Project0502SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            for (int i = 0; i < ha.length; i++) {
                ha[i] = new SixPointedStar(Project0502SurfaceView.this, 0.4f, 1.0f,-1.0f * i);
            }
