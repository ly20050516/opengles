package ly.com.project.sample0505;
...
public class Cube {
    ...
    public Cube(Project0505SurfaceView mv)
    {
        //初始化顶点坐标与着色数据
        initVertexData();
        //初始化shader
    ...
    //初始化shader
    public void initShader(Project0505SurfaceView mv)
    {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("project_sample_5_5/vertex.glsl",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("project_sample_5_5/frag.glsl",
                mv.getResources());
        //基于顶点着色器与片元着色器创建程序
