...
public class Project0506Activity extends AppCompatActivity {

    private Project0506SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化GLSurfaceView
        mGLSurfaceView = new Project0506SurfaceView(this);
        // 切换到主界面
        setContentView(R.layout.activity_project0506);
