 ...
 */
public class Project0506SurfaceView extends GLSurfaceView {

    private SceneRenderer mRenderer;//场景渲染器
    public Project0506SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建点或线对象
            PointsOrLines=new PointsOrLines(Project0506SurfaceView.this);
            //打开深度检测
