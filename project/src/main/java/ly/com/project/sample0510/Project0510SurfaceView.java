...
/**
 * @author：ly on 2019-11-23 20:40
 * @mail：liuyan@zhimei.ai
 */
public class Project0510SurfaceView extends GLSurfaceView {
    ...
    public Project0510SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            cube=new Cube(Project0510SurfaceView.this);
            //打开深度检测
