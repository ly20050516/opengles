...
public class Celestial {
    ...
    public Celestial(float scale,float yAngle,int vCount,Texture0704SurfaceView mv){
        this.yAngle=yAngle;
        this.scale=scale;
        this.vCount=vCount;
        initVertexData();
    ...
    public void intShader(Texture0704SurfaceView mv){    //初始化着色器
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("texture_sample_7_4/vertex_xk.glsl", mv.getResources());
        ShaderUtil.checkGlError("==ss==");
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("texture_sample_7_4/frag_xk.glsl", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
        ShaderUtil.checkGlError("==ss==");
