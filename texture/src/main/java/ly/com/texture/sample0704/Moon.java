...
public class Moon {
    ...
    public Moon(Texture0704SurfaceView mv,float r)
    {
        //初始化顶点坐标与着色数据
        initVertexData(r);
        //初始化shader
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("texture_sample_7_4/vertex_moon.glsl", mv.getResources());
        ShaderUtil.checkGlError("==ss==");
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("texture_sample_7_4/frag_moon.glsl", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
        ShaderUtil.checkGlError("==ss==");
