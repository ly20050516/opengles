package ly.com.texture.sample0704;
...
import static ly.com.texture.sample0704.Constant.ratio;
import static ly.com.texture.sample0704.Constant.threadFlag;

/**
 * @author：ly on 2019-11-10 12:10
 * @mail：liuyan@zhimei.ai
 */
public class Texture0704SurfaceView extends GLSurfaceView {

    public static final String TAG = Texture0704SurfaceView.class.getSimpleName();
    ...
    public Texture0704SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建地球对象
            earth = new Earth(Texture0704SurfaceView.this, 2.0f);
            //创建月球对象
            moon = new Moon(Texture0704SurfaceView.this, 1.0f);
            //创建小星星天球对象
            cSmall = new Celestial(1, 0, 1000, Texture0704SurfaceView.this);
            //创建大星星天球对象
            cBig = new Celestial(2, 0, 500, Texture0704SurfaceView.this);
            //打开深度检测
