package ly.com.vertex.sample1302;
...
public class TextureRect {
    ...
    public TextureRect(Vertex1302SurfaceView mv) {
        //初始化顶点坐标与着色数据
        initVertexData();
        //初始化shader
    ...
    //初始化shader
    public void initShader(Vertex1302SurfaceView mv, int index, String vertexName) {
        //加载顶点着色器的脚本内容
