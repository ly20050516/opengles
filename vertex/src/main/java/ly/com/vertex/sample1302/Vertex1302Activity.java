...
public class Vertex1302Activity extends AppCompatActivity {

    Vertex1302SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //切换到主界面
        setContentView(R.layout.activity_vertex1301);
        //初始化GLSurfaceView
        mGLSurfaceView = new Vertex1302SurfaceView(this);
