 ...
 */
public class Vertex1302SurfaceView extends GLSurfaceView {
    ...
    public Vertex1302SurfaceView(Context context) {
        super(context);
...
//            GLES20.glClearColor(1.0f,1.0f,1.0f,1.0f);
            //创建纹理矩形对对象
            texRect = new TextureRect(Vertex1302SurfaceView.this);
            cuboid = new Cuboid(Vertex1302SurfaceView.this);
            //打开深度检测
