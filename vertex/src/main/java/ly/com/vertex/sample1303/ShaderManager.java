...
public class ShaderManager {
    final static String[][] shaderName =
            {
                    {"vertex_sample_13_03/vertex_tree.glsl", "vertex_sample_13_03/frag_tree.glsl"},//椰子树的着色器
                    {"vertex_sample_13_03/vertex_tex.glsl", "vertex_sample_13_03/frag_tex.glsl"},//纹理贴图的着色器
                    {"vertex_sample_13_03/vertex_water.glsl", "vertex_sample_13_03/frag_water.glsl"},//海水的着色器
                    {"vertex_sample_13_03/vertex_landform.glsl", "vertex_sample_13_03/frag_landform.glsl"},//山的着色器
                    {"vertex_sample_13_03/vertex_leaves.glsl", "vertex_sample_13_03/frag_leaves.glsl"},//叶子的着色器
            };
