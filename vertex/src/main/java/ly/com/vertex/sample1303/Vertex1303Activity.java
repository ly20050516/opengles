 ...
 */
public class Vertex1303Activity extends AppCompatActivity {
    private Vertex1303SurfaceView mGLSurfaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化GLSurfaceView
        mGLSurfaceView = new Vertex1303SurfaceView(this);
    ...
    public void initScreen() {
        ...
        Constant.SCREEN_HEIGHT = getWindowManager().getDefaultDisplay().getHeight();
    }
