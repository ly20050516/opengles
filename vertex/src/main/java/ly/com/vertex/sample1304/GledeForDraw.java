package ly.com.vertex.sample1304;
...
public class GledeForDraw {
    ...
    public GledeForDraw(Vertex1304SurfaceView mv) {
        //初始化顶点坐标与着色数据
        initVertexData(mv);
        //初始化shader
        intShader(mv);
    ...
    //初始化顶点坐标与着色数据的方法
    public void initVertexData(Vertex1304SurfaceView mv) {
        glede_one = LoadUtil.loadFromFileVertexOnly("vertex_sample_13_04/laoying01.obj", mv);
        glede_two = LoadUtil.loadFromFileVertexOnly("vertex_sample_13_04/laoying02.obj", mv)[0];
        glede_three = LoadUtil.loadFromFileVertexOnly("vertex_sample_13_04/laoying03.obj", mv)[0];
    ...
    //初始化shader
    public void intShader(Vertex1304SurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_sample_13_04/vertex_tex.glsl", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("vertex_sample_13_04/frag_tex.glsl", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
