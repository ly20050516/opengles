...
import static ly.com.base.utils.Constant.MAX_S_GHXP;
import static ly.com.base.utils.Constant.MAX_T_GHXP;

/**
 * @author：ly on 2019-12-06 09:24
 * @mail：liuyan@zhimei.ai
 */
public class LoadUtil {
    //从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的平均法向量
    public static float[][] loadFromFileVertexOnly(String fname, GLSurfaceView mv)
    {
