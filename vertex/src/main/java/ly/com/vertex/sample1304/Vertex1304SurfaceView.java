 ...
 */
public class Vertex1304SurfaceView extends GLSurfaceView {
    ...
    public Vertex1304SurfaceView(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            glede1=new GledeForDraw(Vertex1304SurfaceView.this);//创建雄鹰
            //加载纹理
