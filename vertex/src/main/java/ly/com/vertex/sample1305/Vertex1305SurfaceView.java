...
import static ly.com.base.utils.Constant.triangle_edgeLength;
import static ly.com.base.utils.Constant.triangle_levelNum;

/**
 * @author：ly on 2019-12-04 22:32
 * @mail：liuyan@zhimei.ai
 */
public class Vertex1305SurfaceView extends GLSurfaceView {
    ...
    public Vertex1305SurfaceView(Context context) {
        super(context);
    ...
    class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载shader
            ShaderManager.loadCodeFromFile(Vertex1305SurfaceView.this.getResources());
            //编译shader
